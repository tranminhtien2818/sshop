    ...
    <div class="">
        <div class="top-nav" style="display: flex;">
            <ul >
                ...
                <li class="dropdown ctgd hmi"><a style="text-decoration: none" href="#"><span class="hmiu"><span class="hmia">Cửa hàng <span class="caret"></span></span></span></a>
...
<div style="padding: 30px;padding-bottom: 50px;" class="section group">
    <div class="col_1_of_4 span_1_of_4">
        <div class="logo-footer">
            ...
            <p style="color: rgb(208, 208, 208);margin-top: 10px;">22 Hồ Tùng Mậu</p>
            <p style="color: rgb(208, 208, 208);padding: 0 !important;">Mai Dịch, Cầu Giấy, Hà Nội</p>
            <div style="display: flex;color: rgb(208, 208, 208);font-family: verdana, arial, helvetica, helve, sans-serif;margin-top: 12px;
            background: #9b3651;padding: 6px 10px;border-radius: 50px;width: 145px;"><ion-icon style="font-size: 25px;margin-bottom: -2px;" name="call"></ion-icon><p style="font-size: 14px;padding: 0;margin-top: 1px;margin-left: 4px;"> 0995625354</p></div>
        </div>
    </div>
    <div class="col_1_of_4 span_1_of_4">
